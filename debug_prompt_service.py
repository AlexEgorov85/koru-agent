#!/usr/bin/env python3
"""
Диагностический скрипт для проверки создания prompt_service
"""
import asyncio
import sys
import os
...
async def main():
    print("=== Начало диагностики создания prompt_service ===")
    ...
    try:
        ...
        if success:
            ...
            if prompt_service:
                ...
                # Успешно достигнута цель
                print("✓ Цель достигнута: prompt_service успешно создан и зарегистрирован")
                return True
            else:
