...
async def test_new_architecture():
    ...
    print("[OK] Создана тестовая конфигурация с предзагруженными ресурсами")
    ...
    print("[OK] Создан навык с новой архитектурой")
    ...
    print("[OK] Навык успешно инициализирован")
    ...
    print("[OK] Ресурсы успешно загружены в кэш")
    ...
    print("[OK] Доступ к ресурсам через методы работает корректно")
    
    # 8. Создаем контекст выполнения
    execution_context = ExecutionContext(
        available_capabilities=[
            Capability(name="test.capability1", description="Тестовая возможность 1", skill_name="test_skill"),
            Capability(name="test.capability2", description="Тестовая возможность 2", skill_name="test_skill")
        ]
    )
    
    # 9. Выполняем тестовое действие
    capability = Capability(name="planning.create_plan", description="Создание плана", skill_name="planning")
    ...
    print("[OK] Выполнение действия прошло успешно")
    ...
    print("[OK] Навык корректно использует ActionExecutor для взаимодействия")
    
    print("\\n=== Все тесты пройдены успешно! ===")
    print("Новая архитектура компонентов работает корректно:")
    print("- Компоненты изолированы от сервисов")
    print("- Все ресурсы предзагружены в конфигурациях")
