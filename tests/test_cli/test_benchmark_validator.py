...
from core.components.benchmarks import (
    SQLValidator,
    AnswerValidator,
    BenchmarkValidator
)
...
class TestBenchmarkRunnerAgentValidation:
    ...
    def test_extract_sql_from_agent_with_sql_query(self):
        ...
        from core.components.benchmarks.benchmark_runner_agent import _extract_sql_from_agent
    ...
    def test_extract_sql_from_final_answer(self):
        ...
        from core.components.benchmarks.benchmark_runner_agent import _extract_sql_from_final_answer
    ...
    def test_validate_agent_execution_sql_pass(self):
        ...
        from core.components.benchmarks.benchmark_runner_agent import _validate_agent_execution
