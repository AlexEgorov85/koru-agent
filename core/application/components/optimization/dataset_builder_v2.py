...
Это ВЕРСИЯ 2 которая использует traces вместо агрегированных метрик.
"""
import uuid
...
class DatasetBuilderConfig:
    """Конфигурация DatasetBuilder v2"""
    min_samples: int = 50
...
class DatasetBuilder:
    """
    Построитель датасета для оптимизации промптов (ВЕРСИЯ 2).
    ...
    def __init__(
        ...
        """
        Инициализация DatasetBuilder v2.
