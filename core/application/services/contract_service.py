...
class ContractService(BaseService):
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            if missing_contracts:
                self.event_bus_logger.error(f"ContractService: отсутствуют критические контракты: {missing_contracts}")
            ...
            self.event_bus_logger.error(f"Ошибка инициализации ContractService: {e}")
            return False
    ...
    async def preload_contracts(self, component_config) -> bool:
        ...
        try:
            ...
            self.event_bus_logger.error(f"Ошибка предзагрузки контрактов: {e}")
            return False
