...
from core.application.services.base_service import BaseService, ServiceInput, ServiceOutput as BaseServiceOutput
from abc import ABC
...
class SQLGenerationService(BaseService):
    ...
    def __init__(self, application_context: ApplicationContext = None, name: str = "sql_generation_service", component_config=None):
