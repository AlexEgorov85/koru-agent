...
from core.application.services.sql_generation.schema import SQLCorrectionInput, SQLCorrectionOutput
...
class SQLCorrectionEngine(BaseService):
    ...
    def __init__(self, application_context: ApplicationContext, component_config=None):
        ...
        super().__init__("sql_correction_engine", application_context, component_config)
        self.error_analyzer = SQLErrorAnalyzer(application_context, component_config)
    
    async def initialize(self) -> bool:
        """Инициализация движка коррекции"""
        await self.error_analyzer.initialize()
        self.logger.info("SQLCorrectionEngine успешно инициализирован")
        return True
    ...
    async def shutdown(self) -> None:
        ...
        self.logger.info("Завершение работы SQLCorrectionEngine")
