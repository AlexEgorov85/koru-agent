...
from core.infrastructure.services.sql_generation.schema import SQLCorrectionInput, SQLCorrectionOutput
...
class SQLCorrectionEngine(BaseService):
    ...
    def __init__(self, system_context: BaseSystemContext):
        super().__init__(system_context, "sql_correction_engine")
