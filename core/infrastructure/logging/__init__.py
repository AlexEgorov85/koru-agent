...
│ (терминал)      │  │  (день)         │  │ (сессия)        │
│                 │  │                 │  │                 │
│ - онлайн вывод  │  │ - все логи за   │  │ - common.log    │
│ - с цветами     │  │   день          │  │ - llm.jsonl     │
│ - для разраба   │  │ - для отладки   │  │ - metrics.jsonl │
└─────────────────┘  └─────────────────┘  └─────────────────┘

ВАЖНО: Все 3 обработчика нужны!
- Terminal: онлайн вывод для разработчика
- File: агрегация всех логов за день
