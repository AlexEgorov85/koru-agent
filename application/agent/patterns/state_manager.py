...
class ComposablePatternStateManager:
    ...
    def update_state(self, state_id: str, updates: Dict[str, Any]) -> tuple:
        """
        ...
        Returns:
            tuple (bool, list) - (успех операции, список событий для публикации)
        """
        events_to_publish = []
        
        if state_id not in self.pattern_states:
            # Возвращаем событие вместо публикации
            ...
            return False, events_to_publish
