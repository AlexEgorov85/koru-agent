...
[![Version](https://img.shields.io/badge/version-5.41.0-orange.svg)]()
...
## 📊 Последние изменения (v5.41.0)

**Версия 5.41.0** (20 апреля 2026) — **Exploration Mode + MockLLM + gitignore**
