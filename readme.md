...
[![Version](https://img.shields.io/badge/version-5.41.2-orange.svg)]()
...
## 📊 Последние изменения (v5.41.2)

**Версия 5.41.2** (20 апреля 2026) — **Exploration Mode + MockLLM + gitignore**
