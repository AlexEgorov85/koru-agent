# Быстрый старт с Composable AI Agent Framework

В этом руководстве вы узнаете, как быстро начать работу с Composable AI Agent Framework. Мы рассмотрим создание простого агента, выполнение базовой задачи и интеграцию с основными компонентами фреймворка.
...
Это руководство дало вам базовое понимание того, как начать работу с Composable AI Agent Framework. Вы научились:
