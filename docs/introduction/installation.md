# Установка Koru AI Agent Framework

В этом руководстве описан процесс установки и начальной настройки Koru AI Agent Framework. Следуйте инструкциям для быстрого старта работы с фреймворком.
