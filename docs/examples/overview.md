...
В этом разделе представлены примеры использования Koru AI Agent Framework и различные сценарии, демонстрирующие возможности фреймворка. Примеры охватывают различные домены и показывают, как можно использовать компоненты фреймворка для решения реальных задач.
