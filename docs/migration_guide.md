# Руководство по миграции Koru AI Agent Framework

Это руководство описывает процесс миграции Koru AI Agent Framework между версиями и адаптацию существующих компонентов к новым архитектурным изменениям. Вы узнаете, как безопасно обновлять фреймворк и адаптировать свои компоненты под новые версии.
...
Это руководство поможет вам безопасно и эффективно выполнить миграцию Koru AI Agent Framework на новые версии, адаптировав существующие компоненты к новым архитектурным изменениям.