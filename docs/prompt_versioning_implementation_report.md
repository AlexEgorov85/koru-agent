# Отчет о реализации системы версионности промтов
...
Для запуска демонстрации системы версионности промтов выполните:

```bash
python demo_prompt_versioning.py
```

Скрипт покажет:
- Инициализацию промтов в репозитории
- Отображение информации о версиях промтов
- Демонстрацию рендеринга с подстановкой переменных
- Отображение метрик использования