...
Система управления промтами - это ключевой компонент Koru AI Agent Framework, обеспечивающий гибкое управление, версионирование и валидацию промтов. Система позволяет эффективно работать с различными стратегиями взаимодействия с LLM, поддерживает различные домены и провайдеров, а также обеспечивает прозрачность и отслеживаемость использования промтов.
