...
| Навык | Назначение |
|-------|------------|
| **PlanningSkill** | Планирование задач: создание плана, декомпозиция задач, отслеживание прогресса |
...
|------------|------------|
| **SQLTool** | Выполнение SQL-запросов к базе данных |
| **VectorSearchTool** | Семантический поиск по векторной базе (FAISS) |

### Сервисы (Services)

| Сервис | Назначение |
|--------|------------|
| **SqlGenerationService** | Генерация SQL-запросов из естественного языка |
| **SqlQueryService** | Выполнение SQL-запросов с валидацией |
| **SqlValidatorService** | Валидация SQL-запросов на безопасность |
| **JsonParsingService** | Парсинг и валидация JSON-ответов от LLM |
| **StorageService** | Управление хранилищем данных |
| **ComponentRegistry** | Регистрация и discovery компонентов |

### Паттерны поведения (Behaviors)

| Паттерн | Назначение |
|---------|------------|
| **ReAct** | Цикл Reasoning-Acting-Observing: анализ → действие → наблюдение |
| **Planning** | Планирование с декомпозицией задач |
| **Evaluation** | Оценка результатов и качества выполнения |

---

## 5. Contract-First и Управление ресурсами
...
## 6. Оркестрация LLM и Гарантии структурированного вывода
...
## 8. Безопасность и Валидация на уровне исполнения
...
## 9. Сравнение с готовыми решениями
