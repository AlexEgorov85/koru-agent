# Composable AI Agent Framework - Полная документация

Composable AI Agent Framework - это гибкая и расширяемая система для создания, управления и выполнения AI-агентов, способных решать сложные задачи через компонуемые паттерны мышления. В этом файле представлено полное содержание всей документации.
