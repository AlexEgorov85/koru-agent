...
4. [Система промтов](#система-промтов)
5. [Инструменты и навыки](#инструменты-и-навыки)
6. [Ядро системы](#ядро-системы)
7. [Конфигурация](#конфигурация)
8. [Тестирование](#тестирование)
9. [Примеры использования](#примеры-использования)
10. [Безопасность](#безопасность)
11. [Разработка под свои задачи](#разработка-под-свои-задачи)
12. [Миграция](#миграция)
13. [Лучшие практики](#лучшие-практики)

## Введение

### Что такое Composable AI Agent Framework

Composable AI Agent Framework - это система, позволяющая создавать AI-агентов, которые могут комбинировать различные паттерны мышления для решения сложных задач. В отличие от традиционных подходов, где LLM управляет системой напрямую, в этом фреймворке LLM принимает решения, которые строго валидируются и исполняются кодом.

### Основные принципы

- **Компонуемость**: Возможность комбинировать различные паттерны мышления
...
- **Расширяемость**: Легкое создание новых компонентов
...
- Инструменты и атомарные действия
...
### Создание специфических инструментов
