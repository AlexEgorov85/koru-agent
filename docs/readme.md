# Composable AI Agent Framework - Документация

Добро пожаловать в документацию Composable AI Agent Framework - гибкой и расширяемой системы для создания, управления и выполнения AI-агентов, способных решать сложные задачи через компонуемые паттерны мышления.
