...
Навыки (Skills) в Composable AI Agent Framework представляют собой более высокоуровневые абстракции, чем инструменты. Они могут комбинировать несколько инструментов и атомарных действий для выполнения сложных задач. В этом разделе описан процесс создания и интеграции пользовательских навыков.
...
Эти примеры показывают, как создавать и интегрировать пользовательские навыки в Composable AI Agent Framework, обеспечивая расширяемость и гибкость системы.